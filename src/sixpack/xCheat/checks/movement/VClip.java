...
public class VClip extends Check{
	...
	public VClip() {
		super("vclip", "VClip", CheckType.MOVEMENT, true, false, 10);
	}
	
	public VClip(String name, CheckType type, boolean enabled, boolean punishable, int maxV) {
		super("vclip", name, type, enabled, punishable, maxV);
	}
